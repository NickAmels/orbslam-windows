...
set "AMENT_ENVIRONMENT_HOOKS[ros2topic]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2topic] "%AMENT_CURRENT_PREFIX%\share\ros2topic\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ros2topic\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ros2topic\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2topic]:;=";"%") do (
    call:call_file %%f
  )
