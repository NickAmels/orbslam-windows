...
set "AMENT_ENVIRONMENT_HOOKS[ament_uncrustify]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_uncrustify] "%AMENT_CURRENT_PREFIX%\share\ament_uncrustify\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_uncrustify\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_uncrustify\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_uncrustify]:;=";"%") do (
    call:call_file %%f
  )
