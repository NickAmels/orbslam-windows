...
set "AMENT_ENVIRONMENT_HOOKS[ament_cmake_pep8]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_pep8] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_pep8\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cmake_pep8] "%AMENT_CURRENT_PREFIX%\share\ament_cmake_pep8\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cmake_pep8]:;=";"%") do (
    call:call_file %%f
  )
