...
set "AMENT_ENVIRONMENT_HOOKS[ament_index_python]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_index_python] "%AMENT_CURRENT_PREFIX%\share\ament_index_python\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_index_python\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_index_python\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_index_python]:;=";"%") do (
    call:call_file %%f
  )
