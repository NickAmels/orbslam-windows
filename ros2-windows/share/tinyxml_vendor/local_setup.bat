...
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[tinyxml_vendor] "%AMENT_CURRENT_PREFIX%\share\tinyxml_vendor\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\tinyxml_vendor\environment\path.bat"
