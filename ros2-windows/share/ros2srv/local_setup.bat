...
set "AMENT_ENVIRONMENT_HOOKS[ros2srv]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2srv] "%AMENT_CURRENT_PREFIX%\share\ros2srv\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ros2srv\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ros2srv\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2srv]:;=";"%") do (
    call:call_file %%f
  )
