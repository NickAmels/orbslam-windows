...
set "AMENT_ENVIRONMENT_HOOKS[ament_clang_format]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_clang_format] "%AMENT_CURRENT_PREFIX%\share\ament_clang_format\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_clang_format\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_clang_format\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_clang_format]:;=";"%") do (
    call:call_file %%f
  )
