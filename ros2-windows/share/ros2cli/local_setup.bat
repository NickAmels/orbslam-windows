...
set "AMENT_ENVIRONMENT_HOOKS[ros2cli]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2cli] "%AMENT_CURRENT_PREFIX%\share\ros2cli\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ros2cli\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ros2cli\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2cli]:;=";"%") do (
    call:call_file %%f
  )
