...
set "AMENT_ENVIRONMENT_HOOKS[orocos_kdl]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[orocos_kdl] "%AMENT_CURRENT_PREFIX%\share\orocos_kdl\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\orocos_kdl\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[orocos_kdl]:;=";"%") do (
    call:call_file %%f
  )
