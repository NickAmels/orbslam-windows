...
set "AMENT_ENVIRONMENT_HOOKS[uncrustify]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[uncrustify] "%AMENT_CURRENT_PREFIX%\share\uncrustify\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[uncrustify] "%AMENT_CURRENT_PREFIX%\share\uncrustify\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[uncrustify]:;=";"%") do (
    call:call_file %%f
  )
