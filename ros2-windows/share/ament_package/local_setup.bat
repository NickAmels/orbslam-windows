...
set "AMENT_ENVIRONMENT_HOOKS[ament_package]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_package] "%AMENT_CURRENT_PREFIX%\share\ament_package\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_package\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_package\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_package]:;=";"%") do (
    call:call_file %%f
  )
