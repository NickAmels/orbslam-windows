...
set "AMENT_ENVIRONMENT_HOOKS[demo_nodes_py]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[demo_nodes_py] "%AMENT_CURRENT_PREFIX%\share\demo_nodes_py\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\demo_nodes_py\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\demo_nodes_py\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[demo_nodes_py]:;=";"%") do (
    call:call_file %%f
  )
