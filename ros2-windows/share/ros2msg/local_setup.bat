...
set "AMENT_ENVIRONMENT_HOOKS[ros2msg]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2msg] "%AMENT_CURRENT_PREFIX%\share\ros2msg\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ros2msg\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ros2msg\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2msg]:;=";"%") do (
    call:call_file %%f
  )
