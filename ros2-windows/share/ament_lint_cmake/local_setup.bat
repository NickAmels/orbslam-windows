...
set "AMENT_ENVIRONMENT_HOOKS[ament_lint_cmake]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_lint_cmake] "%AMENT_CURRENT_PREFIX%\share\ament_lint_cmake\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_lint_cmake\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_lint_cmake\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_lint_cmake]:;=";"%") do (
    call:call_file %%f
  )
