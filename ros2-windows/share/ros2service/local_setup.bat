...
set "AMENT_ENVIRONMENT_HOOKS[ros2service]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2service] "%AMENT_CURRENT_PREFIX%\share\ros2service\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ros2service\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ros2service\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2service]:;=";"%") do (
    call:call_file %%f
  )
