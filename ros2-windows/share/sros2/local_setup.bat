...
set "AMENT_ENVIRONMENT_HOOKS[sros2]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[sros2] "%AMENT_CURRENT_PREFIX%\share\sros2\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\sros2\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\sros2\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[sros2]:;=";"%") do (
    call:call_file %%f
  )
