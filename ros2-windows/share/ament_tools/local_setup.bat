...
set "AMENT_ENVIRONMENT_HOOKS[ament_tools]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_tools] "%AMENT_CURRENT_PREFIX%\share\ament_tools\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_tools\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_tools\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_tools]:;=";"%") do (
    call:call_file %%f
  )
