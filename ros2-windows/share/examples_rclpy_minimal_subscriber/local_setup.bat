...
set "AMENT_ENVIRONMENT_HOOKS[examples_rclpy_minimal_subscriber]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[examples_rclpy_minimal_subscriber] "%AMENT_CURRENT_PREFIX%\share\examples_rclpy_minimal_subscriber\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\examples_rclpy_minimal_subscriber\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\examples_rclpy_minimal_subscriber\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[examples_rclpy_minimal_subscriber]:;=";"%") do (
    call:call_file %%f
  )
