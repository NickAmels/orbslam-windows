...
set "AMENT_ENVIRONMENT_HOOKS[ros2pkg]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ros2pkg] "%AMENT_CURRENT_PREFIX%\share\ros2pkg\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ros2pkg\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ros2pkg\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ros2pkg]:;=";"%") do (
    call:call_file %%f
  )
