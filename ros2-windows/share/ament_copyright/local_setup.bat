...
set "AMENT_ENVIRONMENT_HOOKS[ament_copyright]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_copyright] "%AMENT_CURRENT_PREFIX%\share\ament_copyright\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_copyright\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_copyright\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_copyright]:;=";"%") do (
    call:call_file %%f
  )
