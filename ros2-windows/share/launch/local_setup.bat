...
set "AMENT_ENVIRONMENT_HOOKS[launch]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[launch] "%AMENT_CURRENT_PREFIX%\share\launch\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\launch\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\launch\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[launch]:;=";"%") do (
    call:call_file %%f
  )
