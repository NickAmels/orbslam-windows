...
set "AMENT_ENVIRONMENT_HOOKS[ament_cppcheck]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cppcheck] "%AMENT_CURRENT_PREFIX%\share\ament_cppcheck\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_cppcheck\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_cppcheck\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cppcheck]:;=";"%") do (
    call:call_file %%f
  )
