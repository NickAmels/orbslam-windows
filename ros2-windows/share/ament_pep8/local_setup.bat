...
set "AMENT_ENVIRONMENT_HOOKS[ament_pep8]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_pep8] "%AMENT_CURRENT_PREFIX%\share\ament_pep8\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_pep8\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_pep8\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_pep8]:;=";"%") do (
    call:call_file %%f
  )
