...
set "AMENT_ENVIRONMENT_HOOKS[ament_pyflakes]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_pyflakes] "%AMENT_CURRENT_PREFIX%\share\ament_pyflakes\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_pyflakes\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_pyflakes\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_pyflakes]:;=";"%") do (
    call:call_file %%f
  )
