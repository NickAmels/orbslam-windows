...
set "AMENT_ENVIRONMENT_HOOKS[ament_cpplint]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[ament_cpplint] "%AMENT_CURRENT_PREFIX%\share\ament_cpplint\environment\ament_prefix_path.bat;%AMENT_CURRENT_PREFIX%\share\ament_cpplint\environment\path.bat;%AMENT_CURRENT_PREFIX%\share\ament_cpplint\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[ament_cpplint]:;=";"%") do (
    call:call_file %%f
  )
