...
/// Initialize lifecycle_msgs/State message.
/**
 * If the init function is called twice for the same message without
 * calling fini inbetween previously allocated memory will be leaked.
 * \param[in,out] msg The previously allocated message pointer.
 * Fields without a default value will not be initialized by this function.
 * You might want to call memset(msg, 0, sizeof(lifecycle_msgs__msg__State)) before
 * or use lifecycle_msgs__msg__State__create() to allocate and initialize the message.
...
/// Finalize lifecycle_msgs/State message.
/**
...
/// Create lifecycle_msgs/State message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls lifecycle_msgs__msg__State__init().
...
/// Destroy lifecycle_msgs/State message.
/**
 * It calls lifecycle_msgs__msg__State__fini() and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lifecycle_msgs
void
...
/// Initialize array of lifecycle_msgs/State messages.
/**
 * It allocates the memory for the number of elements and
 * calls lifecycle_msgs__msg__State__init() for each element of the array.
...
/// Finalize array of lifecycle_msgs/State messages.
/**
 * It calls lifecycle_msgs__msg__State__fini() for each element of the array and
...
/// Create array of lifecycle_msgs/State messages.
/**
 * It allocates the memory for the array and
 * calls lifecycle_msgs__msg__State__Array__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of lifecycle_msgs/State messages.
/**
 * It calls lifecycle_msgs__msg__State__Array__fini() on the array,
