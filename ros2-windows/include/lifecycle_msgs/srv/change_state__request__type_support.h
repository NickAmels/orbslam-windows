...
#ifndef LIFECYCLE_MSGS__SRV__CHANGE_STATE__REQUEST__TYPE_SUPPORT_H_
#define LIFECYCLE_MSGS__SRV__CHANGE_STATE__REQUEST__TYPE_SUPPORT_H_
...
#endif  // LIFECYCLE_MSGS__SRV__CHANGE_STATE__REQUEST__TYPE_SUPPORT_H_
