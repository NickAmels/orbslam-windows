...
#ifndef LIFECYCLE_MSGS__SRV__GET_STATE__RESPONSE__TYPE_SUPPORT_H_
#define LIFECYCLE_MSGS__SRV__GET_STATE__RESPONSE__TYPE_SUPPORT_H_
...
#endif  // LIFECYCLE_MSGS__SRV__GET_STATE__RESPONSE__TYPE_SUPPORT_H_
