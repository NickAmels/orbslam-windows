...
#ifndef DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__RESPONSE__TYPE_SUPPORT_H_
#define DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__RESPONSE__TYPE_SUPPORT_H_
...
#endif  // DIAGNOSTIC_MSGS__SRV__ADD_DIAGNOSTICS__RESPONSE__TYPE_SUPPORT_H_
