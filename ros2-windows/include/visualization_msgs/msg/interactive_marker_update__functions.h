...
/// Initialize visualization_msgs/InteractiveMarkerUpdate message.
/**
 * If the init function is called twice for the same message without
 * calling fini inbetween previously allocated memory will be leaked.
 * \param[in,out] msg The previously allocated message pointer.
 * Fields without a default value will not be initialized by this function.
 * You might want to call memset(msg, 0, sizeof(visualization_msgs__msg__InteractiveMarkerUpdate)) before
 * or use visualization_msgs__msg__InteractiveMarkerUpdate__create() to allocate and initialize the message.
...
/// Finalize visualization_msgs/InteractiveMarkerUpdate message.
/**
...
/// Create visualization_msgs/InteractiveMarkerUpdate message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls visualization_msgs__msg__InteractiveMarkerUpdate__init().
...
/// Destroy visualization_msgs/InteractiveMarkerUpdate message.
/**
 * It calls visualization_msgs__msg__InteractiveMarkerUpdate__fini() and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_visualization_msgs
void
...
/// Initialize array of visualization_msgs/InteractiveMarkerUpdate messages.
/**
 * It allocates the memory for the number of elements and
 * calls visualization_msgs__msg__InteractiveMarkerUpdate__init() for each element of the array.
...
/// Finalize array of visualization_msgs/InteractiveMarkerUpdate messages.
/**
 * It calls visualization_msgs__msg__InteractiveMarkerUpdate__fini() for each element of the array and
...
/// Create array of visualization_msgs/InteractiveMarkerUpdate messages.
/**
 * It allocates the memory for the array and
 * calls visualization_msgs__msg__InteractiveMarkerUpdate__Array__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of visualization_msgs/InteractiveMarkerUpdate messages.
/**
 * It calls visualization_msgs__msg__InteractiveMarkerUpdate__Array__fini() on the array,
