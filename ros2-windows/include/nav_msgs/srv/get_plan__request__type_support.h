...
#ifndef NAV_MSGS__SRV__GET_PLAN__REQUEST__TYPE_SUPPORT_H_
#define NAV_MSGS__SRV__GET_PLAN__REQUEST__TYPE_SUPPORT_H_
...
#endif  // NAV_MSGS__SRV__GET_PLAN__REQUEST__TYPE_SUPPORT_H_
