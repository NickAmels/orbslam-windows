...
#ifndef NAV_MSGS__SRV__SET_MAP__RESPONSE__TYPE_SUPPORT_H_
#define NAV_MSGS__SRV__SET_MAP__RESPONSE__TYPE_SUPPORT_H_
...
#endif  // NAV_MSGS__SRV__SET_MAP__RESPONSE__TYPE_SUPPORT_H_
