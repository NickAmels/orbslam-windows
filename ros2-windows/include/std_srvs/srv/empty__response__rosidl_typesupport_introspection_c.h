...
#ifndef STD_SRVS__SRV__EMPTY__RESPONSE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
#define STD_SRVS__SRV__EMPTY__RESPONSE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
#endif  // STD_SRVS__SRV__EMPTY__RESPONSE__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
