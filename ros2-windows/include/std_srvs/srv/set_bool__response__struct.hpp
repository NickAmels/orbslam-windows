...
#ifndef STD_SRVS__SRV__SET_BOOL__RESPONSE__STRUCT_HPP_
#define STD_SRVS__SRV__SET_BOOL__RESPONSE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED_std_srvs_srv_SetBool_Response __attribute__((deprecated))
#else
# define DEPRECATED_std_srvs_srv_SetBool_Response __declspec(deprecated)
#endif
...
struct SetBool_Response_
{
  ...
  explicit SetBool_Response_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_std_srvs_srv_SetBool_Response
    std::shared_ptr<std_srvs::srv::SetBool_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_std_srvs_srv_SetBool_Response
    std::shared_ptr<std_srvs::srv::SetBool_Response_<ContainerAllocator> const>
...
#endif  // STD_SRVS__SRV__SET_BOOL__RESPONSE__STRUCT_HPP_
