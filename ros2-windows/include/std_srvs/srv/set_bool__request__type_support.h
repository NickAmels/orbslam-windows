...
#ifndef STD_SRVS__SRV__SET_BOOL__REQUEST__TYPE_SUPPORT_H_
#define STD_SRVS__SRV__SET_BOOL__REQUEST__TYPE_SUPPORT_H_
...
#endif  // STD_SRVS__SRV__SET_BOOL__REQUEST__TYPE_SUPPORT_H_
