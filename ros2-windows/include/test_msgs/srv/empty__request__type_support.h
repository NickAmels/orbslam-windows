...
#ifndef TEST_MSGS__SRV__EMPTY__REQUEST__TYPE_SUPPORT_H_
#define TEST_MSGS__SRV__EMPTY__REQUEST__TYPE_SUPPORT_H_
...
#endif  // TEST_MSGS__SRV__EMPTY__REQUEST__TYPE_SUPPORT_H_
