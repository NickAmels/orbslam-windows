...
#ifndef TEST_MSGS__SRV__PRIMITIVES_H_
#define TEST_MSGS__SRV__PRIMITIVES_H_
...
const rosidl_service_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, test_msgs, Primitives)();

#if defined(__cplusplus)
}
#endif

#endif  // TEST_MSGS__SRV__PRIMITIVES_H_
