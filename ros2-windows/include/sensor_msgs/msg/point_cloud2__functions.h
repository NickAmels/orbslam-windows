...
/// Initialize sensor_msgs/PointCloud2 message.
/**
 * If the init function is called twice for the same message without
 * calling fini inbetween previously allocated memory will be leaked.
 * \param[in,out] msg The previously allocated message pointer.
 * Fields without a default value will not be initialized by this function.
 * You might want to call memset(msg, 0, sizeof(sensor_msgs__msg__PointCloud2)) before
 * or use sensor_msgs__msg__PointCloud2__create() to allocate and initialize the message.
...
/// Finalize sensor_msgs/PointCloud2 message.
/**
 ...
 * calls sensor_msgs__msg__PointCloud2__init().
...
/// Destroy sensor_msgs/PointCloud2 message.
/**
 * It calls sensor_msgs__msg__PointCloud2__fini() and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_msgs
void
...
/// Initialize array of sensor_msgs/PointCloud2 messages.
/**
 * It allocates the memory for the number of elements and
 * calls sensor_msgs__msg__PointCloud2__init() for each element of the array.
...
/// Finalize array of sensor_msgs/PointCloud2 messages.
/**
 * It calls sensor_msgs__msg__PointCloud2__fini() for each element of the array and
...
/// Create array of sensor_msgs/PointCloud2 messages.
/**
 * It allocates the memory for the array and
 * calls sensor_msgs__msg__PointCloud2__Array__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of sensor_msgs/PointCloud2 messages.
/**
 * It calls sensor_msgs__msg__PointCloud2__Array__fini() on the array,
