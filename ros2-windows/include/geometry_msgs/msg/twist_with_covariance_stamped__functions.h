...
/// Initialize geometry_msgs/TwistWithCovarianceStamped message.
/**
 * If the init function is called twice for the same message without
 * calling fini inbetween previously allocated memory will be leaked.
 * \param[in,out] msg The previously allocated message pointer.
 * Fields without a default value will not be initialized by this function.
 * You might want to call memset(msg, 0, sizeof(geometry_msgs__msg__TwistWithCovarianceStamped)) before
 * or use geometry_msgs__msg__TwistWithCovarianceStamped__create() to allocate and initialize the message.
...
/// Finalize geometry_msgs/TwistWithCovarianceStamped message.
/**
...
/// Create geometry_msgs/TwistWithCovarianceStamped message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls geometry_msgs__msg__TwistWithCovarianceStamped__init().
...
/// Destroy geometry_msgs/TwistWithCovarianceStamped message.
/**
 * It calls geometry_msgs__msg__TwistWithCovarianceStamped__fini() and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs
void
...
/// Initialize array of geometry_msgs/TwistWithCovarianceStamped messages.
/**
 * It allocates the memory for the number of elements and
 * calls geometry_msgs__msg__TwistWithCovarianceStamped__init() for each element of the array.
...
/// Finalize array of geometry_msgs/TwistWithCovarianceStamped messages.
/**
 * It calls geometry_msgs__msg__TwistWithCovarianceStamped__fini() for each element of the array and
...
/// Create array of geometry_msgs/TwistWithCovarianceStamped messages.
/**
 * It allocates the memory for the array and
 * calls geometry_msgs__msg__TwistWithCovarianceStamped__Array__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of geometry_msgs/TwistWithCovarianceStamped messages.
/**
 * It calls geometry_msgs__msg__TwistWithCovarianceStamped__Array__fini() on the array,
