...
#ifndef _WIN32
# define DEPRECATED_geometry_msgs_msg_AccelStamped __attribute__((deprecated))
#else
# define DEPRECATED_geometry_msgs_msg_AccelStamped __declspec(deprecated)
#endif
...
struct AccelStamped_
{
  ...
  explicit AccelStamped_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_geometry_msgs_msg_AccelStamped
    std::shared_ptr<geometry_msgs::msg::AccelStamped_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_geometry_msgs_msg_AccelStamped
    std::shared_ptr<geometry_msgs::msg::AccelStamped_<ContainerAllocator> const>
