...
/// Initialize geometry_msgs/PoseWithCovarianceStamped message.
/**
 * If the init function is called twice for the same message without
 * calling fini inbetween previously allocated memory will be leaked.
 * \param[in,out] msg The previously allocated message pointer.
 * Fields without a default value will not be initialized by this function.
 * You might want to call memset(msg, 0, sizeof(geometry_msgs__msg__PoseWithCovarianceStamped)) before
 * or use geometry_msgs__msg__PoseWithCovarianceStamped__create() to allocate and initialize the message.
...
/// Finalize geometry_msgs/PoseWithCovarianceStamped message.
/**
 ...
 * calls geometry_msgs__msg__PoseWithCovarianceStamped__init().
...
/// Destroy geometry_msgs/PoseWithCovarianceStamped message.
/**
 * It calls geometry_msgs__msg__PoseWithCovarianceStamped__fini() and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_geometry_msgs
void
...
/// Initialize array of geometry_msgs/PoseWithCovarianceStamped messages.
/**
 * It allocates the memory for the number of elements and
 * calls geometry_msgs__msg__PoseWithCovarianceStamped__init() for each element of the array.
...
/// Finalize array of geometry_msgs/PoseWithCovarianceStamped messages.
/**
 * It calls geometry_msgs__msg__PoseWithCovarianceStamped__fini() for each element of the array and
...
/// Create array of geometry_msgs/PoseWithCovarianceStamped messages.
/**
 * It allocates the memory for the array and
 * calls geometry_msgs__msg__PoseWithCovarianceStamped__Array__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of geometry_msgs/PoseWithCovarianceStamped messages.
/**
 * It calls geometry_msgs__msg__PoseWithCovarianceStamped__Array__fini() on the array,
