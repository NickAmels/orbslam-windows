...
#include "geometry_msgs/msg/accel_with_covariance.hpp"  // accel
#include "std_msgs/msg/header.hpp"  // header

#ifndef _WIN32
# define DEPRECATED_geometry_msgs_msg_AccelWithCovarianceStamped __attribute__((deprecated))
#else
# define DEPRECATED_geometry_msgs_msg_AccelWithCovarianceStamped __declspec(deprecated)
#endif
...
struct AccelWithCovarianceStamped_
{
  ...
  explicit AccelWithCovarianceStamped_(const ContainerAllocator & _alloc)
...
// *INDENT-ON*
  ...
  typedef DEPRECATED_geometry_msgs_msg_AccelWithCovarianceStamped
    std::shared_ptr<geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED_geometry_msgs_msg_AccelWithCovarianceStamped
    std::shared_ptr<geometry_msgs::msg::AccelWithCovarianceStamped_<ContainerAllocator> const>
